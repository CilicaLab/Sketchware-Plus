...
- Ani1nonly
- Dava
- Ilyasse Salama        (for the new About Sketchware Plus activity)
- Zarzo
...
Also, starting with version 6.4.0 of the Mod, we've made some source code open source! You can check it out at https://github.com/Sketchware-Pro/Sketchware-Plus/,
and if you want to contribute, go fork it and open a pull request! We'd love to see new amazing features getting added to Sketchware Plus :D

★ The change log can be found in the mod's Main Drawer.

**** FOR MODDERS ****

I made this part specifically for my fellow modders who want to contribute to Sketchware Plus's development. Think of it as a little documentation :)
