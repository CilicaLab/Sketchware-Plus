...
import static sketchware.plus.utility.FileUtil.deleteFile;
import static sketchware.plus.utility.FileUtil.getExternalStorageDir;
import static sketchware.plus.utility.FileUtil.isExistFile;
import static sketchware.plus.utility.FileUtil.listDirAsFile;
import static sketchware.plus.utility.FileUtil.readFile;
import static sketchware.plus.utility.FileUtil.writeFile;
...
public class LocalLibrariesUtil {
    ...
    public static List<LocalLibrary> getAllLocalLibraries() {
        ...
        return localLibraryFiles.stream()
