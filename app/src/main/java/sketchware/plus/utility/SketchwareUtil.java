...
public class SketchwareUtil {
    ...
    /**
     * Provides feedback using haptics if supported, otherwise falls back to vibration.
     *
     * @param view     The view to perform haptic feedback on.
     * @param vibrator The vibrator to use as fallback.
     * @param duration The fallback vibration duration in milliseconds.
     */
    public static void vibrate(View view, Vibrator vibrator, long duration) {
        if (view != null) {
