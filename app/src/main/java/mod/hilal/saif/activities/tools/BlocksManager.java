...
import sketchware.plus.databinding.ActivityBlocksManagerBinding;
import sketchware.plus.databinding.DialogBlockConfigurationBinding;
import sketchware.plus.databinding.DialogPaletteBinding;
                ...
                if (actionState == ItemTouchHelper.ACTION_STATE_DRAG) {
                    ...
                    if (isItInTrash(draggedView, binding.recycleBin)) {
                        ...
                        if (!isCurrentlyActive && pos != RecyclerView.NO_POSITION && pos < pallet_listmap.size() && !isDialogShowing) {
                            SketchwareUtil.vibrate(draggedView, vibrator, 40L);
