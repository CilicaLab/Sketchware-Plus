...
import sketchware.plus.activities.editor.component.ManageCustomComponentActivity;
import sketchware.plus.activities.settings.SettingsActivity;
import sketchware.plus.databinding.ActivityAppSettingsBinding;
import sketchware.plus.databinding.DialogSelectApkToSignBinding;
...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        generalCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_folder, "Open working directory", "Open Sketchware Plus's directory and edit files in it", v -> openWorkingDirectory()), true);
