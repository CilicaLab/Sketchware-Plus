...
public class ComponentBean extends CollapsibleBean implements Parcelable {
    ...
    public static final int COMPONENT_TYPE_FIREBASE_FIRESTORE = 32;
    public static final int COMPONENT_TYPE_FIREBASE_CRASHLYTICS = 33;
    ...
    public static String getComponentName(Context context, int type) {
        return switch (type) {
            ...
            case COMPONENT_TYPE_FIREBASE_FIRESTORE -> "Firestore";
            case COMPONENT_TYPE_FIREBASE_CRASHLYTICS -> "Crashlytics";
    ...
    public static int getComponentTypeByTypeName(String typeName) {
        return switch (typeName) {
            ...
            case "FirebaseFirestore" -> COMPONENT_TYPE_FIREBASE_FIRESTORE;
            case "FirebaseCrashlytics" -> COMPONENT_TYPE_FIREBASE_CRASHLYTICS;
    ...
    public static String getComponentTypeName(int type) {
        return switch (type) {
            ...
            case COMPONENT_TYPE_FIREBASE_FIRESTORE -> "FirebaseFirestore";
            case COMPONENT_TYPE_FIREBASE_CRASHLYTICS -> "FirebaseCrashlytics";
