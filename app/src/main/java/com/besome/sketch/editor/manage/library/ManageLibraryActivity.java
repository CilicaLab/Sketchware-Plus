    ...
    private static class SaveLibraryTask extends MA {
        ...
        public void a() {
            ...
            if (activity != null) {
                ...
                intent.putExtra("firebase", activity.firebaseLibraryBean);
                intent.putExtra("compat", activity.compatLibraryBean);
                intent.putExtra("admob", activity.admobLibraryBean);
                intent.putExtra("google_map", activity.googleMapLibraryBean);
        ...
        public void b() {
            ...
            if (activity != null) {
                try {
                    activity.saveLibraryConfiguration();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
