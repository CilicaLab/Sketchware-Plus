...
import sketchware.plus.widgets.WidgetsCreatorManager;
...
public class ViewEditorFragment extends qA {
    ...
    public void initialize(ProjectFileBean projectFileBean) {
        ...
        // Defer palette loading to improve perceived startup time
        viewEditor.post(this::e);
    }
                ...
                synchronized (manager) {
                    if (actionType == HistoryViewBean.ACTION_TYPE_ADD) {
                        ...
                        if (currentUpdateData.id.equals("_fab")) {
                            manager.h(projectFileBean.getXmlName()).copy(currentUpdateData);
                        } else {
                            manager.c(projectFileBean.getXmlName(), prevUpdateData.id).copy(currentUpdateData);
                        }
                        ...
                        for (ViewBean viewBean : historyViewBean.getRemovedData()) {
                            manager.a(projectFileBean, viewBean);
                        }
                        ...
                        ViewBean viewBean = manager.c(projectFileBean.getXmlName(), movedData.id);
                        ...
                        manager.c.put(projectFileBean.getXmlName(), historyViewBean.getAddedData());
                        i();
                    }
                }
            }
                ...
                synchronized (manager) {
                    if (actionType == HistoryViewBean.ACTION_TYPE_ADD) {
                        for (ViewBean view : historyViewBean.getAddedData()) {
                            manager.a(projectFileBean, view);
                        }
                        ...
                        if (currentUpdateData.id.equals("_fab")) {
                            manager.h(projectFileBean.getXmlName()).copy(prevUpdateData);
                        } else {
                            manager.c(projectFileBean.getXmlName(), currentUpdateData.id).copy(prevUpdateData);
                        }
                        viewEditor.a(viewEditor.e(prevUpdateData), false);
                    } else if (actionType == HistoryViewBean.ACTION_TYPE_REMOVE) {
                        for (ViewBean view : historyViewBean.getRemovedData()) {
                            manager.a(projectFileBean.getXmlName(), view);
                        }
                        ...
                        manager.c.put(projectFileBean.getXmlName(), historyViewBean.getRemovedData());
                        i();
                    }
                }
            }
